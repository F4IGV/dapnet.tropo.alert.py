# dapnet.tropo.alert.py
script python permettant de générer un indice de propagation troposphérique et capable d'envoyer des alerte de propagation sur le dapnet en pocsag.
